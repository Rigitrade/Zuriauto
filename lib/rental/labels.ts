...
const de = {
  ...
  manage: {
    ...
    vehicle: "Fahrzeug",
    plate: "Kontrollschild-Nr.",
    endsAt: "Vereinbarte Rückgabe",
    returnHeading: "Fahrzeug zurückgeben",
    returnBody: "Wir notieren die Rückgabe und melden uns bei Ihnen für die Übergabe.",
    returnCta: "Ich gebe das Fahrzeug zurück",
    returnDone: "Danke — wir haben Ihre Rückgabe notiert und melden uns.",
    extendHeading: "Miete verlängern",
    extendBody: "Wählen Sie, um wie viele Wochen Sie verlängern möchten.",
    extendWeeks: "Zusätzliche Wochen",
    extendPrice: "Zusätzlicher Betrag",
    extendNewEnd: "Neue Rückgabe",
    extendCta: "Verlängern",
    extendDone: "Ihre Miete wurde verlängert. Die Bestätigung ist unterwegs.",
    payNow: "Jetzt bezahlen",
    working: "Wird verarbeitet …",
    failed: "Das hat nicht funktioniert. Bitte rufen Sie uns an.",
    unusableTitle: "Link nicht mehr gültig",
    unusableBody: "Dieser Link wurde bereits verwendet oder ist abgelaufen. Bitte rufen Sie uns an oder antworten Sie auf unsere E-Mail — wir senden Ihnen einen neuen.",
    notExtendable: "Diese Miete kann nicht online verlängert werden. Bitte rufen Sie uns an.",
...
const en: typeof de = {
  ...
  manage: {
    heading: "Your rental",
    intro: "Please let us know how you would like to proceed.",
    vehicle: "Vehicle",
    plate: "Licence plate no.",
    endsAt: "Agreed return",
    returnHeading: "Return the car",
    returnBody: "We will note the return and contact you to arrange the handover.",
    returnCta: "I will return the car",
    returnDone: "Thank you — we have noted your return and will be in touch.",
    extendHeading: "Extend the rental",
    extendBody: "Choose how many more weeks you would like.",
    extendWeeks: "Additional weeks",
    extendPrice: "Additional amount",
    extendNewEnd: "New return date",
    extendCta: "Extend",
    extendDone: "Your rental has been extended. The confirmation is on its way.",
    payNow: "Pay now",
    working: "Working …",
    failed: "That did not work. Please call us.",
    unusableTitle: "Link no longer valid",
    unusableBody: "This link has already been used or has expired. Please call us or reply to our email and we will send a new one.",
    notExtendable: "This rental cannot be extended online. Please call us.",
